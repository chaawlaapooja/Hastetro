...
class EditUser extends Component{
  ...
  handle_image_upload(file) {
	...
	return(
		...
		<td>{this.refs.nomineeBirthday?typeof(this.refs.nomineeBirthday.value)==='object'?new Date(this.refs.nomineeBirthday.value).toLocaleDateString():undefined:undefined}</td>
		</tr>
		<tr>
                        ...
                        <div className="tab-content" id="myTabContent">
                            <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div className="row register-form">
                                	<label>HTPL ID :</label>
									<input type="text" ref="ID" placeholder="ID" pattern="HT[0-9]{7}" title="ID starts with HTPL followed by 5 digits." required/>
										<div className="col-md-6" hidden={this.state.hideInputFields}>
	                                        ...
	                                        <div className="form-group">
												...
												<input type="date"  ref="birthday" required={!this.state.hideInputFields} readOnly/><br/><br/>
											</div>
	                                        <div className="form-group">
							                    <label>Mobile :</label>
												<input type="text" ref="mobile" placeholder='Mobile' pattern="[6-9]{1}[0-9]{9}" title="10 digit valid mobile number" required={!this.state.hideInputFields}/><br/>
											</div>
											<div className="form-group">
								                <label>Village :</label>
												<input type="text" ref="village" placeholder='Village' pattern="[a-zA-Z].{2,}" title='Enter three or more characters' required={!this.state.hideInputFields}/>
											</div>
											<div className="form-group">
								                <label>Tahsil :</label>
												<input type="text" ref="tahsil" placeholder='Tahsil' pattern="[a-zA-Z].{2,}" title='Enter three or more characters' required={!this.state.hideInputFields}/><br/>
											</div>
											<div className="form-group">
								                <label>District :</label>
												<input type="text" ref="district" placeholder='District' pattern="[a-zA-Z].{2,}" title='Enter three or more characters' required={!this.state.hideInputFields}/>
											</div>
											<div className="form-group">
							                	<label>Pin Code :</label>
												<input type="text" ref="pincode" placeholder='PinCode' pattern="^[1-9][0-9]{5}$" title='Enter three or more characters' required={!this.state.hideInputFields}/><br/>
											</div>
											<div className="form-group">
							                	<label>State :</label>
												<select ref="state" className="form-control" required={!this.state.hideInputFields}>
													<option></option>
	                                    ...
	                                    <div className="col-md-6" hidden={this.state.hideInputFields}>
										    ...
										    <div className="form-group">
												...
												<select ref="nomineeRelation" required={!this.state.hideInputFields}>
											     	<option value=''></option>
												...
												<input type="text" ref="nomineeName" placeholder="Nominee's Name" pattern="[a-zA-Z].{2,}" title='Enter three or more characters' required={!this.state.hideInputFields}/><br/>
												<div hidden>
                                ...
                                <input type="submit" style={{margin:'1%'}} className="btn btn-primary" value={this.state.hideInputFields?'Search':'Update'}/>
                                <Link to='/' style={{margin:'1%'}} className='pull-right'><button className='btn btn-danger'>Cancel</button></Link>
                                </div>
                                </form>
                            </div>
      					</div>
